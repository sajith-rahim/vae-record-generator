...
# Implementation from Reversible DT

class OneHotEncodingTransformer():
    r"""OneHotEncoding for categorical data.
    ...
    def _prepare_data(data):
        r"""Transform data to appropriate format.
    ...
    def fit(self, data):
        r"""Fit the transformer to the data.
    ...
    def transform(self, data):
        r"""Replace each category with the OneHot vectors.
        Args:
            data (pandas.Series, numpy.ndarray, list or list of lists):
                Data to transform.
        Returns:
    ...
    def reverse_transform(self, data):
        r"""Convert float values back to the original categorical values.
        Args:
            data (numpy.ndarray):
                Data to revert.
        Returns:
